...
// Description: contains data structures/functions pertaining to the
// 	gathering and storing of humidity data
...
// Function Prototypes:
//
// Callback Functions: user_read_humidity();
// Desc: Gets a single humidity reading from the humidity sensor via I2C
void ICACHE_FLASH_ATTR user_read_humidity();
